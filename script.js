      ...
      setTimeout(function () {
        for (let i = 0; i < entries.length; i++) {
          if (entry.isIntersecting) {
            ...
            const htmlCssJs = document.querySelector('.bar_html');
            const react = document.querySelector('.bar_react');
            const express = document.querySelector('.bar_express');
            const java = document.querySelector('.bar_java');
            const tailwind = document.querySelector('.bar_tailwind');
            const db = document.querySelector('.bar_db');
            const git = document.querySelector('.bar_git');
            target[i] = htmlCssJs.style.width = "95%";
            target[i] = react.style.width = "80%";
            target[i] = express.style.width = "80%";
            target[i] = java.style.width = "68%";
            target[i] = tailwind.style.width = "80%";
            target[i] = db.style.width = "75%";
